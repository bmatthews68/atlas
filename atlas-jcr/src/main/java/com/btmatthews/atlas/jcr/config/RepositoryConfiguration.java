...
import com.btmatthews.atlas.jcr.JCRTemplate;
import com.btmatthews.atlas.jcr.PoolableSessionFactory;
...
public class RepositoryConfiguration {
	...
	@Bean
	public KeyedPoolableObjectFactory<String, Session> getPoolableObjectFactory() {
	...
	public SessionPool getSessionPool() {
		return new SessionPoolImpl(getPoolableObjectFactory());
	}

	@Bean
	public JCRAccessor getJcrTemplate() {
		final SessionPool sessionPool = getSessionPool();
